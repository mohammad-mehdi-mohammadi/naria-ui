...
function App() {
    ...
    return (
        <>
            ...
            <Select options = {[{label: 1, value: "Yellow"}, {label: 2, value: "Red"}, {label: 3, value: "Blue"}]} selected = {2} />
            <Select label = "id" value = "name" options = {[{id: 1, name: "Yellow"}, {id: 2, name: "Red"}, {id: 3, name: "Blue"}]} />
            <Select label = "id" value = "name" options = {[{id: 1, name: "Yellow"}, {id: 2, name: "Red"}, {id: 3, name: "Blue"}]} selected = {3} />
        </>
    )
}
